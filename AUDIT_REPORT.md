...
**المتوسطة (57): 39 مُصلَح · 1 جزئي · 17 مفتوح.**
- **✅ مُصلَح (39):** M‑S1 · S2 · S3 · **S5** · S6 · S8 · **B1** · B3 · B4 · **B6** · B8 · **B9** · **B10** · **B11** · B12 · B15 · B16 · **B17** · B19 · **B20** · B21 · **B22** · **B23** · **B24** · B25 · **B26** · **B27** · **B28** · **B29** · B30 · **Q1** · **Q2** · **Q4** · **Q7** · Q8 · **Q9** · **T1** · T2 · T4. (الغامق = أُصلح في #20.)
- **◐ جزئي (1):** M‑A3 (حُذفت سكربتات `migrate` فقط؛ لا خطّ هجرات ولا بوّابة `migrate diff` — `db push` غير التفاعلي باقٍ بقرار).
- **⬚ مفتوح (17):** أمن/سلامة تحتاج قراراً أو عملاً أكبر: **M‑S4** (تقارير PII بلا مصادقة) · **M‑S7** (refresh في localStorage) · M‑B2 (ترقيم الحركات) · M‑B5 (سباق طلب نشط — يحتاج فهرس/هجرة) · M‑B7 (نافذة refresh بعد التعيين — عمود schema) · M‑B13 (`onDelete: Cascade` مالي — schema) · M‑B14 (`User.phone` فريد عالمياً — schema) · M‑B18 (kanban الطلبات) · M‑T3 (`tsconfig.build.json` — يمسّ مسار الإنتاج). وإعادة هيكلة (جودة، بلا تغيير سلوك): M‑A1 · M‑A2 · M‑Q3 (تفكيك `complete()`) · M‑Q5 (كتالوجات أسعار الخطط) · M‑Q6 (`gatherReportData`) · M‑Q10 · M‑Q11 · M‑Q12.

**أُصلِح في الجلسة #20 (21 بنداً، كلّها بلا مسّ عقد الـ API وبتحقّق):**
