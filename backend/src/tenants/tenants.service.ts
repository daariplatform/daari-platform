...
export class TenantsService {
  ...
  async getSettings(tenantId: string) {
    ...
    return {
      ...
      city: tenant.city,
      refillPriceIqd: tenant.refillPriceIqd ?? 1000,
      deliveryFeeIqd: tenant.deliveryFeeIqd ?? 0,
      freeDeliveryThresholdIqd: tenant.freeDeliveryThresholdIqd ?? null,
      coverageKm: tenant.coverageKm ?? 7,
      workingHoursStart: tenant.workingHoursStart ?? '08:00',
      workingHoursEnd: tenant.workingHoursEnd ?? '22:00',
