...
└── apps/
    ...
    └── admin/      ← تطبيق الإدارة (11 شاشة)  · com.phibit.daariadmin
        ...
        #       تبويبات: الرئيسية · التقارير · الفريق · المزيد (المتبقّي: لمسات تكافؤ)
```
...
> (مصادقة + **قفل بصمة (`local_auth`)** + لوحة مؤشّرات حيّة + التقارير الأساسية والمتقدّمة + الفريق بإجراءاته + العروض + المخزون + تهيئة المعمل + **خريطة أسطول حيّة**)،
> والمتبقّي **لمسات تكافؤ** (مفتاح خرائط للإنتاج، عروض السائقين/التدقيق). الحالة التفصيلية في **[`PROGRESS.md`](PROGRESS.md)**.
